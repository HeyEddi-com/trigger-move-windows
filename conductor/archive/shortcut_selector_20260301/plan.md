...
- [x] Task: Integrate `ShortcutRecorder` into the application rows in the main preferences view.
- [x] Task: Connect key capture to GSettings persistence logic.
- [x] Task: Perform final integration testing of the entire flow (Record -> Validate -> Save -> Trigger). 4361573
- [x] Task: Update documentation and commit. 4361573
