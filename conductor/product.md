...
- **Native-style Shortcut Recording:** Assign keyboard shortcuts by simply pressing the desired key combination, featuring a polished UI with interactive feedback.
- **Automatic Conflict Detection:** Real-time warnings when a chosen shortcut is already in use by another application or the system.
