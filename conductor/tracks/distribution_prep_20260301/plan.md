...
- [ ] Task: Review `extension.js` and `prefs.js` against GNOME's technical requirements
- [ ] Task: Update `metadata.json` with detailed description and project URL
- [ ] Task: Conductor - User Manual Verification 'Phase 1: Compliance' (Protocol in workflow.md)
